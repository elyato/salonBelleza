...
export const Footer = () => {
  return (
 <Box  sx={{ bgcolor: '#000000', width: '100%', p: 2, mt: 4, }}>
          <Grid container spacing={5} size={{ xs: 12, sm: 6, md: 12 }} sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
            <Grid  >
              <Typography variant="h5" sx={{ fontFamily: 'Playfair Display, serif',  color: '#FFFFFF' }}>
                Nail Studio
              </Typography>
              <Typography variant="caption" sx={{ mt: 1 ,color:"white"}}>Tu destino para el cuidado y embellecimiento de manos y pies. Creando arte en cada una de tus visitas.</Typography>
            </Grid>
            <Grid  >
            ...
            <Grid >
              ...
              <Typography
                component="a"
                href="https://www.instagram.com/aaalejandra_nails/?hl=es"
                target="_blank"
